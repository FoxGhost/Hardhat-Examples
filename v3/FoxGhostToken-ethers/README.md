...
This project showcases a Hardhat 3 Beta project using [`mocha`](https://mochajs.org/next/) for tests and the [`ethers`](https://docs.ethers.org/v6/) library for Ethereum interactions.
